...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  try {
    ...
    // For now forcing dark mode aesthetics as per previous designs
    ...
    const mostProductive = calculateMostProductiveDayFull(rawData);
  ...
  <defs>
    ...
    <style>
      ...
      /* UPDATED ICON STYLE HERE: Changed fill to white, opacity to 0.12 */
  ...
  <g transform="translate(${padding}, 5)" class="font-base">
    ...
    <g transform="translate(0,0)">
      ...
      <g transform="translate(20, 24)">
        ...
        <text class="stat-unit" x="0" y="62">${toReadableDate(mostProductive.date)}</text>
      </g>
